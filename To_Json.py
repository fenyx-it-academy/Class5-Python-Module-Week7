...
class Product:
    ...
    def tojson(self):
        self.dict = {"name": self.name, "brand": {"brand_name": self.brand.name, "brand_year": self.brand.year}, "price": self.price}
...
giant = Brand("giant", 2010)
bike = Product("bike", giant, "300")
bike.tojson()
